...
public class ProductsAssertionTest {
    ...
    //11. Verify that the total is equal to 51957
    @Test
    public void test011() { //.total HW
        response.body("total", equalTo(51957));
    }

    //12. Verify that the stores of limit is equal to 10
    @Test
    public void test012() {
    ...
    @Test
    public void test015() {
        response.body("data.categories[2].name", hasItem("Household Batteries"));
    }
